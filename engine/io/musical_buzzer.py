...
crabrave_notes = [c[4], db[4], d[4], eb[4], c[4], db[4], d[4], eb[4],
                c[4], db[4], d[4], eb[4], c[4], db[4], d[4], eb[4]]
crabrave_beats = [2, 1, 2, 2, 2, 1, 2, 2, 2, 1, 2, 2, 1, 2, 1, 1 ]
crabrave_tempo = 0.2
...
def sing_note(x):
    bat_notes = [c[x]]
    playSong(bat_notes, [1], 0.2)

def play_intro_song():
    playSong(crabrave_notes, crabrave_beats, crabrave_tempo)
